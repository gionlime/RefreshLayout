...
public class RefreshLayout extends ViewGroup {
    ...
    private float mDampFactor = 0.3f; // 滑动阻尼系数
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mEnable = typedArray.getBoolean(R.styleable.lib_refresh_RefreshLayout_enable, true);
        mGravity = typedArray.getInt(R.styleable.lib_refresh_RefreshLayout_gravity, 0x11);
        typedArray.recycle();
    }
